...
if (isset($_POST['submit'])) {
    ...
    $insert_data = array(
        'username'    => mysqli_real_escape_string($data->connection(), $_POST['uname']),
        'firstname'   => mysqli_real_escape_string($data->connection(), $_POST['fname']),
        'lastname'    => mysqli_real_escape_string($data->connection(), $_POST['lname']),
        'password'    => mysqli_real_escape_string($data->connection(), $_POST['pwd']),
        'email'       => mysqli_real_escape_string($data->connection(), $_POST['email']),
        'designation' => mysqli_real_escape_string($data->connection(), $_POST['desig']),
        'join_date'   => mysqli_real_escape_string($data->connection(), $_POST['join']),
        'experience'  => mysqli_real_escape_string($data->connection(), $_POST['exp']),
        'created'     => mysqli_real_escape_string($data->connection(), $_POST['created_date']),
    );
    ...
    if ($users->insertUser("user", $insert_data)) {
